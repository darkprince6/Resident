<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MinteBranches.aspx.cs" Inherits="Resident.WebPage.Public.MinteBranches" %>
                ...
                <div class="col-sm-8">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <asp:DetailsView ID="dvwMaintBranch" runat="server" AutoGenerateRows="False" DataKeyNames="Id" Enabled="false"
                                ...
                                DataSourceID="SqlDvw" DefaultMode="Insert" OnItemInserted="dvwMaintBranch_ItemInserted" OnItemInserting="dvwMaintBranch_ItemInserting"
                                OnItemUpdating="dvwMaintBranch_ItemUpdating" OnItemUpdated="dvwMaintBranch_ItemUpdated">
                                <Fields>
                                    <asp:BoundField DataField="Id" HeaderText="Id" ReadOnly="True" InsertVisible="False" SortExpression="Id"></asp:BoundField>

                                    <asp:TemplateField HeaderText="Branch">
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" Text='<%# Bind("Branch") %>' ID="txtBranch" CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ErrorMessage="* Required" ForeColor="Crimson" ControlToValidate="txtBranch"
                                                runat="server" Display="Dynamic" ValidationGroup="valMaintBranch" Font-Size="XX-Small" SetFocusOnError="true" />
                                        </EditItemTemplate>
                                        <InsertItemTemplate>
                                            <asp:TextBox runat="server" Text='<%# Bind("Branch") %>' ID="txtBranch" CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ErrorMessage="* Required" ForeColor="Crimson" ControlToValidate="txtBranch"
                                    ...
                                    <asp:CommandField ShowInsertButton="true" InsertText="Submit" ButtonType="Button"
                                        ControlStyle-CssClass="btn btn-outline-primary btn-sm" ValidationGroup="valMaintBranch" />
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDvw" ConnectionString='<%$ ConnectionStrings:ResiCon %>'
                                SelectCommand="SELECT [Id], [Branch], [Descr] FROM [MaintBranches] WHERE Id=@Id"
                                InsertCommand="INSERT INTO MaintBranches(ResComId, ParentBranchId, Branch, Descr, CrBy, CrByIP, CrDt) 
                                        VALUES (@ResComId, @ParentBranchId, @Branch, @Descr, @CrBy, @CrByIP, @CrDt)"
                                UpdateCommand="UPDATE MaintBranches SET Branch = @Branch, Descr = @Descr, 
                                ...
                                <InsertParameters>
                                    ...
                                    <asp:Parameter Name="Branch"></asp:Parameter>
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="gvwMaintBranch" Name="Id" PropertyName="SelectedValue" Type="Int32" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="Branch"></asp:Parameter>
                                    <asp:Parameter Name="Descr"></asp:Parameter>
                            ...
                            <div>
                                <asp:GridView ID="gvwMaintBranch" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
                                    OnSelectedIndexChanged="gvwMaintBranch_SelectedIndexChanged" EmptyDataText="There is no data to show."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Branch">
                                            <ItemTemplate>
                                                <asp:Label runat="server" Text='<%# Eval("Branch") %>' ID="lblBranch"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
