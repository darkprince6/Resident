...
namespace Resident.WebPage.Public
{
    public partial class Maintenance : System.Web.UI.Page
    {
        ...
        {
            dvwMaintPost.ChangeMode(DetailsViewMode.Insert);
            dvwMaintPost.Enabled = true;
            dvwMaintPost.DataBind();
        ...
        private void BindGvw()
        {
            ...
            using (con)
            {
                string sql = "SELECT [Id], [PName], [Descr] FROM [MaintPosts] WHERE BranchId=@BranchId";
                using (SqlCommand cmd = new SqlCommand(sql, con))
                {
                    cmd.Parameters.Add("@BranchId", SqlDbType.Int).Value = hdnBranchId.Value;
            ...
            gvwMaintPost.DataSource = table;
            gvwMaintPost.DataBind();
        }

        protected void dvwMaintPost_ItemInserted(object sender, DetailsViewInsertedEventArgs e)
        {
            dvwMaintPost.ChangeMode(DetailsViewMode.Insert);
            BindGvw();
        ...
        protected void dvwMaintPost_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
            e.Values["ResComId"] = hdnRoot.Value;
            e.Values["BranchId"] = hdnBranchId.Value;
        ...
        protected void dvwMaintPost_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
        {
        ...
        protected void dvwMaintPost_ItemUpdated(object sender, DetailsViewUpdatedEventArgs e)
        {
            dvwMaintPost.ChangeMode(DetailsViewMode.Insert);
            BindGvw();
            tvMaintBranches.Nodes.Clear();
        ...
        protected void gvwMaintPost_SelectedIndexChanged(object sender, EventArgs e)
        {
            dvwMaintPost.Visible = true;
            dvwMaintPost.ChangeMode(DetailsViewMode.Edit);
        }
    }
}