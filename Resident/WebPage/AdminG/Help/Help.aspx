<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Help.aspx.cs" Inherits="Resident.WebPage.AdminG.Help" %>
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group m-2px">
                                        ...
                                        <asp:TextBox ID="txtTitleForHelpIns" runat="server" Placeholder="... enter a title" CssClass="form-control form-control-sm" Font-Size="Small"></asp:TextBox>
