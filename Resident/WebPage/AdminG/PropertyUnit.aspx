<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyUnit.aspx.cs" Inherits="Resident.WebPage.AdminG.PropertyUnit" %>
    ...
    <form id="form1" runat="server">
       ...
       <%--     <asp:UpdatePanel runat="server">
                <ContentTemplate>--%>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <asp:TreeView ID="tvPropertyFlow" runat="server" ImageSet="Arrows" NodeIndent="15" ShowLines="false"
                                OnSelectedNodeChanged="tvPropertyFlow_SelectedNodeChanged" CssClass="jumbotron">
