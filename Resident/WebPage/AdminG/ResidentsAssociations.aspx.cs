...
{
    public partial class ResidentsAssociations : System.Web.UI.Page
    {
        ...
        protected void ddlResiCom_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (HttpContext.Current != null && HttpContext.Current.User.Identity.IsAuthenticated)
            {
                ...
                {
                    divResAsso.Visible = true;
                    dvwResAsso.ChangeMode(DetailsViewMode.Insert);
        ...
        protected void dvwResAsso_ItemInserting(object sender, DetailsViewInsertEventArgs e)
        {
            if (HttpContext.Current != null &&
                               HttpContext.Current.User.Identity.IsAuthenticated)
            {
                #region Logo
                FileUpload _fuLogo = dvwResAsso.FindControl("fuLogo") as FileUpload;
                ...
                #region Image1
                FileUpload _fuImage1 = dvwResAsso.FindControl("fuImage1") as FileUpload;
        ...
        protected void dvwResAsso_ItemInserted(object sender, DetailsViewInsertedEventArgs e)
        {
            if (HttpContext.Current != null &&
                    HttpContext.Current.User.Identity.IsAuthenticated)
            {
        ...
        protected void dvwResAsso_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
        {
            if (HttpContext.Current != null &&
                               HttpContext.Current.User.Identity.IsAuthenticated)
            {
        ...
        protected void dvwResAsso_ItemUpdated(object sender, DetailsViewUpdatedEventArgs e)
        {
            if (HttpContext.Current != null &&
                    HttpContext.Current.User.Identity.IsAuthenticated)
            {
        ...
        protected void gvwResAsso_SelectedIndexChanged(object sender, EventArgs e)
        {
            dvwResAsso.Visible = true;
            dvwResAsso.ChangeMode(DetailsViewMode.Edit);
        }
    }
}