...
namespace Resident.WebPage.AdminG
{
    public partial class PropertyUnit : System.Web.UI.Page
    {
        ...
        protected void tvPropertyFlow_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            if (ViewState["Name"].ToString() == "Avik")
            {
            ...
            {
                Response.Write("Hello"+ Session["Name"].ToString());
            }
